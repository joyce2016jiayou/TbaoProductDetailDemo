...
public abstract class BaseActivity extends BasePermissionsActivity {
    ...
    private TextView action_esc_tv;//标题栏左侧文字
    ...
    private void initTitleBar() {
        ...
        action_esc_tv = rlTitleBar.findViewById(R.id.action_esc_tv);
        action_esc_tv.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                finish();
            }
        ...
        //初始化自己写的布局
//        View layout_view = LayoutInflater.from(this).inflate(getContentViewResId(), null);
//        RelativeLayout.LayoutParams layoutParams = new RelativeLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT,
//                RelativeLayout.LayoutParams.MATCH_PARENT);
//        layoutParams.topMargin=MeasureUnitTranUtil.dip2px(this,64);
//        layout_view.setLayoutParams(layoutParams);

        //动态判断添加
        ViewGroup viewGroup = (ViewGroup) findViewById(android.R.id.content);
        View mRootView = viewGroup.getChildAt(0);
        ...
        //viewGroup.addView(layout_view,1);
    ...
    protected void hideEsc() {
        ...
        action_esc_tv.setVisibility(View.GONE);
    }
    protected void hideEscText() {
        action_esc.setVisibility(View.GONE);
        action_esc_tv.setVisibility(View.GONE);
    }
    /**
    ...
    protected void showEscText() {
        action_esc.setVisibility(View.GONE);
        action_esc_tv.setVisibility(View.VISIBLE);
    ...
    protected void setLeftTv(String text) {
        this.action_esc_tv.setText(text);
    }
     ...
     * 设置左侧文字内容
     */
    protected void setLeftTv(int resId) {
        this.action_esc_tv.setText(resId);
    }
    ...
    protected void setLeftTvTextColor(int color) {
        action_esc_tv.setTextColor(color);
    }
     ...
     * @param textSizeSP
     */
    protected void setLeftTvTextSize(int textSizeSP) {
        action_esc_tv.setTextSize(TypedValue.COMPLEX_UNIT_SP, textSizeSP);
    }
     ...
     * @return
     */
    protected TextView getEscText() {
        return action_esc_tv;
    }
