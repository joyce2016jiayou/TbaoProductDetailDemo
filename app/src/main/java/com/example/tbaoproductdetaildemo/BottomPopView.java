...
public class BottomPopView extends BasePopupView {
    protected SmartDragLayout bottomPopupContainer;
    private int layout_view;
    private ViewCallBack viewCallBack;
    protected FrameLayout centerPopupContainer;

    public BottomPopView(@NonNull Context context, int layout, ViewCallBack m_viewCallBack) {
        super(context);
        layout_view = layout;
    ...
    protected int getPopupLayoutId() {
        return com.lxj.xpopup.R.layout._xpopup_bottom_popup_view;
    }
    ...
    protected void initPopupContent() {
        ...
        View contentView = LayoutInflater.from(getContext()).inflate(layout_view, bottomPopupContainer, false);
        ...
        bottomPopupContainer.setOnCloseListener(new SmartDragLayout.OnCloseListener() {
            ...
            @Override
            public void onOpen() {
                BottomPopView.super.doAfterShow();
            }
        });
